...
# singer_registration
enter_your_name_text = "Пожалуйста, напишите Ваше полное имя."
...
info_button_names_text = ("Голос", "Костюмы", "Посещаемость", "Комментарий", "УДАЛИТЬ")
song_filter_text = ("Все", "В работе", "По концертам")
chose_filter_text = "Выберите фильтр песен или посмотрите весь репертуар:"
chose_concert_text = "Выберите концерт:"
edit_buttons_text = ("Добавить", "Удалить")
